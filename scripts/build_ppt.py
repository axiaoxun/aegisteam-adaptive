...
p0_fills = {
    ...
    "【描述真实场景与核心痛点】": "大部分政府事业单位与中小企业:年安全预算<50万、专职安全<3人,却要扛高频攻击+等保2.0/数安法/个保法/生成式AI办法,雇不起50人团队",
    "【概述端到端解决方案】": "8岗位化Agent + 1人机协同层 + A6自适应引擎;3编排流(告警/监管/新法规)端到端跑通",
...
render_blocks(prs.slides[6], [
    ("title", "五层架构"),
    ("bullet", "L1 Team编排(AgentTeams/hiclaw, A0) · L2 8岗位Agent · L3 32 Skill · L4 6MCP+5RAG · L0.5 人机协同 · L5 可观测"),
    ("title", "端到端主流程"),
...
render_blocks(comp_slide, [
    ...
    ("table", [
        ...
        ["本质", "告警研判引擎(更聪明的面板)", "8岗位化自适应安全运营团队"],
