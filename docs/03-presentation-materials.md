...
> 核心叙事:**8 个岗位化安全 Agent + 1 个人机协同层 = 7×24 自适应 AI 安全运营团队**
...
- **核心内容**
  ...
  - 副标题:8 个岗位化安全 Agent + 1 个人机协同层 = 7×24 自适应 AI 安全运营团队
...
### Page 02 — 一句话定位
- **核心内容**
  - "8 个岗位化安全 Agent + 1 个人机协同层,复刻一支 7×24 自适应 AI 安全运营团队"
...
### Page 03 — 痛点 1:大部分政府事业单位与中小企业的人力/预算/物力三重压力
- **核心内容**
  - 大数字:大部分政府事业单位与中小企业年安全预算 < 50 万、专职安全 < 3 人
...
### Page 06 — 我们的答案
- **核心内容**
  - 答案公式:**8 岗位化安全 Agent + 1 人机协同层 = 7×24 自适应 AI 安全运营团队**
  - 8 Agent 对应 8 个真实岗位:Leader / 资产 / 告警 / 漏洞 / 合规 / 响应 / 质量治理 / 复盘
  - 32 个可复用 Skill 沉淀组织能力,跨任务复用(其中 A6 QualitySteward 新增 4 个治理 Skill)
  - 边界:低风险自动闭环,高风险必审批必审计,所有动作可证据回放
  - **人机协同层双模式**:有 Web 平台时多角色协同审批(工程师 / 合规官 / 业务负责人);无平台时通过钉钉 / 企微推送对应角色
- **视觉元素建议**
  - 等式大字居中"8 岗位化安全 Agent + 1 人机协同层 = 7×24 自适应 AI 安全运营团队"
  - 下方 8 个 Agent 头像一字排开
  - 右侧 32 Skill 网格占位 + 人机协同层双模式小图
- **对应评审维度**:场景价值 25%(核心答案)
...
### Page 09 — 32 个 Skill 体系(8 大类)
- **核心内容**
  - 8 大类分组:编排 4 / 资产 4 / 检测 4 / 漏洞 4 / 合规 4 / 响应 3 / 质量 4 / 复盘 5 = **32**
...
AegIsLoop Adaptive(AegIsLoop 自适应 AI 安全运营)面向大部分政府事业单位与中小企业,核心理念是"8 个岗位化安全 Agent + 1 个人机协同层 = 7×24 自适应 AI 安全运营团队"。

依托金融行业的领先安全经验,相关成果可迁移至任何有「等保 2.0 二级以上」合规要求的单位——政务 / 医疗 / 教育 / 能源 / 制造。

把真实环境下的网络安全岗位做成 8 个岗位化 Agent,用 AgentTeams 编排 + 32 个可复用 Skill + MCP/RAG 工具底座,叠加人机协同层和 A6 自适应引擎,形成具备处理各类型复杂网络安全事件的管理+技术运营团队。

**痛点**:大部分政府事业单位与中小企业面临安全预算、专职安全人员不足问题,面对高频攻击告警 / 监管通报整改 / 新法规落地等常见网络安全场景,存在 4 个痛点:守不住(24h 值守)、来不及(快速响应)、讲不通(便捷沟通)、落不下(制度落地)。

**解决方案**:3 条核心编排流——告警流(22 步)、监管通报流(26 步)、新法规响应流(14 步,管理+技术双路),L0-L3 四级安全分级 + H1/H2 审批关口 + A6 自适应引擎质量治理。5 套 RAG + 6 类 MCP 工具,10 区大屏 + 人机协同层双模式(Web 平台 / IM 通道)。

**差异化**:岗位化 1:1 映射真实 SOC;A6 QualitySteward 实时质量治理让系统"自适应";AgentTeams + Skill + MCP + RAG + 可观测五层架构可轻松复现。

**团队与开源**:3 人团队,金融行业 10 年安全运营经验;Apache 2.0 协议全栈开源,提供 Mock 剧本与部署文档;Roadmap:SIEM/SOAR 接入、多模态告警、跨团队协同、Adaptive Engine 自学新攻击手法。
...
| `src/skills/` | 32 Skill × 3 文件 ≈ 96 | Skill 工程 25% |
...
- 18 页 PPT 大纲:**已完成 v1.2**(每页含核心内容 / 视觉建议 / 评审维度标注,核心叙事统一为"8 岗位化安全 Agent + 1 人机协同层 = 7×24 自适应 AI 安全运营团队")
- 500 字项目简介:**已完成 v1.2**(采用"8 岗位化安全 Agent + 1 人机协同层"新叙事,约 500 字,符合比赛附录 C 模板的凝练表达)
- GitHub 仓库结构:**已完成 v1.2**(8 Agent + 32 Skill + 5 RAG + 人机协同层双模式,约 200-220 文件规模,Apache 2.0 全栈开源)
